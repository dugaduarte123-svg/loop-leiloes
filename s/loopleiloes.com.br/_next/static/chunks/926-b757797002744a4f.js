        ...
        67642: function(t, e, s) {
            ...
            const o = {
                ...
                u = ({
                    type: t,
                    data: e
                }, s, n) => a && e instanceof Blob ? s ? n(e) : p(e, n) : h && (e instanceof ArrayBuffer || c(e)) ? s ? n(e) : p(new Blob([e]), n) : n(r[t] + (e || "")),
                p = (t, e) => {
            ...
            for (let Bt = 0; Bt < f.length; Bt++) y[f.charCodeAt(Bt)] = Bt;
            const g = "function" === typeof ArrayBuffer,
                ...
                _ = (t, e) => {
                    if (g) {
                        const s = (t => {
                            let e, s, n, r, i, o = .75 * t.length,
                                a = t.length,
                                h = 0;
                            "=" === t[t.length - 1] && (o--, "=" === t[t.length - 2] && o--);
                            const c = new ArrayBuffer(o),
                                u = new Uint8Array(c);
                            for (e = 0; e < a; e += 4) s = y[t.charCodeAt(e)], n = y[t.charCodeAt(e + 1)], r = y[t.charCodeAt(e + 2)], i = y[t.charCodeAt(e + 3)], u[h++] = s << 2 | n >> 4, u[h++] = (15 & n) << 4 | r >> 2, u[h++] = (3 & r) << 6 | 63 & i;
                            return c
                        })(t);
                        return b(s, e)
                    }
                ...
                b = (t, e) => "blob" === e ? t instanceof Blob ? t : new Blob([t]) : t instanceof ArrayBuffer ? t : t.buffer,
            ...
            function v() {
                return new TransformStream({
                    transform(t, e) {
                        ! function(t, e) {
                            a && t.data instanceof Blob ? t.data.arrayBuffer().then(l).then(e) : h && (t.data instanceof ArrayBuffer || c(t.data)) ? e(l(t.data)) : u(t, !1, (t => {
            ...
            function x(t, e) {
                e.useNativeTimers ? (t.setTimeoutFn = B.bind(R), t.clearTimeoutFn = N.bind(R)) : (t.setTimeoutFn = R.setTimeout.bind(R), t.clearTimeoutFn = R.clearTimeout.bind(R))
            }
            ...
            class q extends T {
                ...
                onError(t, e, s) {
                    return super.emitReserved("error", new L(t, e, s)), this
                }
                open() {
            ...
            class P extends q {
                ...
                uri() {
                    const t = this.opts.secure ? "https" : "http",
                        e = this.query || {};
                    return !1 !== this.opts.timestampRequests && (e[this.opts.timestampParam] = S()), this.supportsBinary || e.sid || (e.b64 = 1), this.createUri(t, e)
                }
            }
            let j = !1;
            try {
            ...
            class F extends T {
                constructor(t, e, s) {
                    super(), this.createRequest = t, x(this, s), this._opts = s, this._method = s.method || "GET", this._uri = e, this._data = void 0 !== s.data ? s.data : null, this._create()
                }
                _create() {
                    var t;
                    const e = C(this._opts, "agent", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "autoUnref");
                    ...
                    "undefined" !== typeof document && (this._index = F.requestsCount++, F.requests[this._index] = this)
                }
                _onError(t) {
                ...
                _cleanup(t) {
                    if ("undefined" !== typeof this._xhr && null !== this._xhr) {
                        if (this._xhr.onreadystatechange = U, t) try {
                            this._xhr.abort()
                        } catch (e) {}
                        "undefined" !== typeof document && delete F.requests[this._index], this._xhr = null
                    }
                }
                _onLoad() {
            ...
            if (F.requestsCount = 0, F.requests = {}, "undefined" !== typeof document)
                ...
                addEventListener("onpagehide" in R ? "pagehide" : "unload", M, !1)
            }
            ...
            const K = "undefined" !== typeof navigator && "string" === typeof navigator.product && "reactnative" === navigator.product.toLowerCase();
            class W extends q {
                get name() {
                    return "websocket"
                }
                doOpen() {
                    const t = this.uri(),
                        ...
                        s = K ? {} : C(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
                ...
                uri() {
                    const t = this.opts.secure ? "wss" : "ws",
                        e = this.query || {};
                    return this.opts.timestampRequests && (e[this.opts.timestampParam] = S()), this.supportsBinary || (e.b64 = 1), this.createUri(t, e)
                }
            }
            const Y = R.WebSocket || R.MozWebSocket;
            const z = {
                    websocket: class extends W {
                        createSocket(t, e, s) {
                            return K ? new Y(t, e, s) : e ? new Y(t, e) : new Y(t)
                        }
                        doWrite(t, e) {
                            this.ws.send(e)
                        }
                                                ...
                                                transform(a, h) {
                                                    for (s.push(a);;) {
                                                        if (0 === n) {
                                                            if (E(s) < 1) break;
                                                            const t = A(s, 1);
                                                            i = 128 === (128 & t[0]), r = 127 & t[0], n = r < 126 ? 3 : 126 === r ? 1 : 2
                                                        } else if (1 === n) {
                                                            if (E(s) < 2) break;
                                                            const t = A(s, 2);
            ...
            class Z extends T {
                constructor(t, e) {
                    ...
                    x(this, e), this.secure = null != e.secure ? e.secure : "undefined" !== typeof location && "https:" === location.protocol, e.hostname && !e.port && (e.port = this.secure ? "443" : "80"), this.hostname = e.hostname || ("undefined" !== typeof location ? location.hostname : "localhost"), this.port = e.port || ("undefined" !== typeof location && location.port ? location.port : this.secure ? "443" : "80"), this.transports = [], this._transportsByName = {}, e.transports.forEach((t => {
                        ...
                        return e
                    }(this.opts.query)), X && (this.opts.closeOnBeforeunload && (this._beforeunloadEventListener = () => {
                    ...
                    }, G.push(this._offlineEventListener))), this.opts.withCredentials && (this._cookieJar = void 0), this._open()
                }
                createTransport(t) {
                ...
                _open() {
                    ...
                    const t = this.opts.rememberUpgrade && Z.priorWebsocketSuccess && -1 !== this.transports.indexOf("websocket") ? "websocket" : this.transports[0];
                ...
                onOpen() {
                    this.readyState = "open", Z.priorWebsocketSuccess = "websocket" === this.transport.name, this.emitReserved("open"), this.flush()
                }
                _onPacket(t) {
                ...
                _onError(t) {
                    if (Z.priorWebsocketSuccess = !1, this.opts.tryAllTransports && this.transports.length > 1 && "opening" === this.readyState) return this.transports.shift(), this._open();
                    this.emitReserved("error", t), this._onClose("transport error", t)
                }
                _onClose(t, e) {
                    if ("opening" === this.readyState || "open" === this.readyState || "closing" === this.readyState) {
                        if (this.clearTimeoutFn(this._pingTimeoutTimer), this.transport.removeAllListeners("close"), this.transport.close(), this.transport.removeAllListeners(), X && (this._beforeunloadEventListener && removeEventListener("beforeunload", this._beforeunloadEventListener, !1), this._offlineEventListener)) {
                            const t = G.indexOf(this._offlineEventListener); - 1 !== t && G.splice(t, 1)
                        }
            ...
            class tt extends Z {
                ...
                _probe(t) {
                    ...
                    e.once("open", n), e.once("error", i), e.once("close", o), this.once("close", a), this.once("upgrading", h), -1 !== this._upgrades.indexOf("webtransport") && "webtransport" !== t ? this.setTimeoutFn((() => {
                        s || e.open()
                    }), 200) : e.open()
                }
                onHandshake(t) {
            ...
            class et extends tt {
                constructor(t, e = {}) {
                    const s = "object" === typeof t,
                        n = s ? { ...t
                        } : { ...e
                        };
                    (!n.transports || n.transports && "string" === typeof n.transports[0]) && (n.transports = (n.transports || ["polling", "websocket", "webtransport"]).map((t => z[t])).filter((t => !!t))), super(s ? n : t, n)
                }
            }
            const st = "function" === typeof ArrayBuffer,
                ...
                it = "function" === typeof File || "undefined" !== typeof File && "[object FileConstructor]" === nt.call(File);

            function ot(t) {
                return st && (t instanceof ArrayBuffer || (t => "function" === typeof ArrayBuffer.isView ? ArrayBuffer.isView(t) : t.buffer instanceof ArrayBuffer)(t)) || rt && t instanceof Blob || it && t instanceof File
            }
            ...
            function at(t, e) {
                ...
                if (ot(t)) return !0;
                if (t.toJSON && "function" === typeof t.toJSON && 1 === arguments.length) return at(t.toJSON(), !0);
                for (const s in t)
                    if (Object.prototype.hasOwnProperty.call(t, s) && at(t[s])) return !0;
                return !1
            }
            ...
            function ht(t) {
                const e = [],
                    s = t.data,
                    n = t;
                return n.data = ct(s, e), n.attachments = e.length, {
                    packet: n,
                    buffers: e
                }
            }
            ...
            function ct(t, e) {
                ...
                if (Array.isArray(t)) {
                    ...
                    for (let n = 0; n < t.length; n++) s[n] = ct(t[n], e);
                    return s
                }
                if ("object" === typeof t && !(t instanceof Date)) {
                    const s = {};
                    for (const n in t) Object.prototype.hasOwnProperty.call(t, n) && (s[n] = ct(t[n], e));
                    return s
                }
                return t
            }
            ...
            function pt(t, e) {
                ...
                if (Array.isArray(t))
                    for (let s = 0; s < t.length; s++) t[s] = pt(t[s], e);
                else if ("object" === typeof t)
                    for (const s in t) Object.prototype.hasOwnProperty.call(t, s) && (t[s] = pt(t[s], e));
                return t
            }
            const lt = ["connect", "connect_error", "disconnect", "disconnecting", "newListener", "removeListener"],
                dt = 5;
            var ft;
            ! function(t) {
            ...
            class yt {
                ...
                encode(t) {
                    return t.type !== ft.EVENT && t.type !== ft.ACK || !at(t) ? [this.encodeAsString(t)] : this.encodeAsBinary({
                ...
                encodeAsString(t) {
                    let e = "" + t.type;
                    return t.type !== ft.BINARY_EVENT && t.type !== ft.BINARY_ACK || (e += t.attachments + "-"), t.nsp && "/" !== t.nsp && (e += t.nsp + ","), null != t.id && (e += t.id), null != t.data && (e += JSON.stringify(t.data, this.replacer)), e
                }
                encodeAsBinary(t) {
                    const e = ht(t),
            ...
            class gt extends T {
                ...
                add(t) {
                    ...
                    if ("string" === typeof t) {
                        ...
                        s || e.type === ft.BINARY_ACK ? (e.type = s ? ft.EVENT : ft.ACK, this.reconstructor = new mt(e), 0 === e.attachments && super.emitReserved("decoded", e)) : super.emitReserved("decoded", e)
                    } else {
                ...
                decodeString(t) {
                    ...
                    if (void 0 === ft[s.type]) throw new Error("unknown packet type " + s.type);
                    if (s.type === ft.BINARY_EVENT || s.type === ft.BINARY_ACK) {
                        ...
                        const i = Number(r);
                        if (!_t(i) || i < 0) throw new Error("Illegal attachments");
                    ...
                    if (t.charAt(++e)) {
                        ...
                        if (!gt.isPayloadValid(s.type, n)) throw new Error("invalid payload");
                        s.data = n
                    }
                    return s
                }
                ...
                static isPayloadValid(t, e) {
                    switch (t) {
                        ...
                        case ft.BINARY_EVENT:
                            return Array.isArray(e) && ("number" === typeof e[0] || "string" === typeof e[0] && -1 === lt.indexOf(e[0]));
                        case ft.ACK:
                        case ft.BINARY_ACK:
            ...
            const _t = Number.isInteger || function(t) {
            ...
            function wt(t) {
                return "string" === typeof t.nsp && (void 0 === (e = t.id) || _t(e)) && function(t, e) {
                    switch (t) {
                        case ft.CONNECT:
            ...
            class Et extends T {
                ...
                subEvents() {
                    if (this.subs) return;
                    const t = this.io;
                    this.subs = [vt(t, "open", this.onopen.bind(this)), vt(t, "packet", this.onpacket.bind(this)), vt(t, "error", this.onerror.bind(this)), vt(t, "close", this.onclose.bind(this))]
                }
                get active() {
                    return !!this.subs
                }
                ...
                emit(t, ...e) {
                    var s, n, r;
                    if (kt.hasOwnProperty(t)) throw new Error('"' + t.toString() + '" is a reserved event name');
                    ...
                    const o = null === (n = null === (s = this.io.engine) || void 0 === s ? void 0 : s.transport) || void 0 === n ? void 0 : n.writable,
                        a = this.connected && !(null === (r = this.io.engine) || void 0 === r ? void 0 : r._hasPingExpired());
            ...
            At.prototype.duration = function() {
                ...
                this.attempts = 0
            }, At.prototype.setMin = function(t) {
                this.ms = t
            }, At.prototype.setMax = function(t) {
                this.max = t
            }, At.prototype.setJitter = function(t) {
                this.jitter = t
            };
            class Tt extends T {
                constructor(t, e) {
                    var s;
                    super(), this.nsps = {}, this.subs = [], t && "object" === typeof t && (e = t, t = void 0), (e = e || {}).path = e.path || "/socket.io", this.opts = e, x(this, e), this.reconnection(!1 !== e.reconnection), this.reconnectionAttempts(e.reconnectionAttempts || 1 / 0), this.reconnectionDelay(e.reconnectionDelay || 1e3), this.reconnectionDelayMax(e.reconnectionDelayMax || 5e3), this.randomizationFactor(null !== (s = e.randomizationFactor) && void 0 !== s ? s : .5), this.backoff = new At({
                ...
                onopen() {
                    ...
                    const t = this.engine;
                    this.subs.push(vt(t, "ping", this.onping.bind(this)), vt(t, "data", this.ondata.bind(this)), vt(t, "error", this.onerror.bind(this)), vt(t, "close", this.onclose.bind(this)), vt(this.decoder, "decoded", this.ondecoded.bind(this)))
                }
                onping() {
                ...
                socket(t, e) {
                    let s = this.nsps[t];
                    return s ? this._autoConnect && !s.active && s.connect() : (s = new Et(this, t, e), this.nsps[t] = s), s
                }
                _destroy(t) {
            ...
            function Rt(t, e) {
                ...
                const s = function(t, e = "", s) {
                        let n = t;
                        s = s || "undefined" !== typeof location && location, null == t && (t = s.protocol + "//" + s.host), "string" === typeof t && ("/" === t.charAt(0) && (t = "/" === t.charAt(1) ? s.protocol + t : s.host + t), /^(https?|wss?):\/\//.test(t) || (t = "undefined" !== typeof s ? s.protocol + "//" + t : "https://" + t), n = Q(t)), n.port || (/^(http|ws)$/.test(n.protocol) ? n.port = "80" : /^(http|ws)s$/.test(n.protocol) && (n.port = "443")), n.path = n.path || "/";
                    ...
                    r = s.id,
                    i = s.path,
                    o = Ot[r] && i in Ot[r].nsps;
                let a;
                return e.forceNew || e["force new connection"] || !1 === e.multiplex || o ? a = new Tt(n, e) : (Ot[r] || (Ot[r] = new Tt(n, e)), a = Ot[r]), s.query && !e.query && (e.query = s.queryKey), a.socket(s.path, e)
            }
            Object.assign(Rt, {
                Manager: Tt,
                Socket: Et,
