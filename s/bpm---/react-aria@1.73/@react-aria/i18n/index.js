...
class $5b160d28a433310d$export$c17fa47878dc55b6 {
    ...
    constructor(messages, defaultLocale = 'en-US') {
        ...
        this.strings = Object.assign({}, messages);
...
class $fb18d541ea1ad717$export$ad991b66133851cf {
    ...
    formatRangeToParts(start, end) {
        ...
        return [...startParts.map(p => Object.assign({}, p, {
            source: 'startRange'
        })), {
            type: 'literal',
            value: ' – ',
            source: 'shared'
        }, ...endParts.map(p => Object.assign({}, p, {
            source: 'endRange'
        }))];
    }
...
function $fb18d541ea1ad717$var$getResolvedHourCycle(locale, options) {
    ...
    let formatter = $fb18d541ea1ad717$var$getCachedDateFormatter(locale, Object.assign({}, options, {
...
class $488c6ddbf4ef74c2$export$cc77c4ff7e8673c5 {
    ...
    resolvedOptions() {
        ...
        if (!$488c6ddbf4ef74c2$var$supportsSignDisplay && this.options.signDisplay != null) options = Object.assign({}, options, {
            signDisplay: this.options.signDisplay
        });
        if (!$488c6ddbf4ef74c2$var$supportsUnit && this.options.style === 'unit') options = Object.assign({}, options, {
            style: 'unit',
...
function $fca6afa0e843324b$export$f12b703ca79dfbb1(strings) {
    ...
    return useMemo(() => new $6db58dc88e78b024$export$2f817fcdc4b89ae0(locale, dictionary), [locale, dictionary]);
}
...
function $896ba0a80a8f4d36$export$85fd5fdf27bacc79(options) {
    ...
    return useMemo(() => new $fb18d541ea1ad717$export$ad991b66133851cf(locale, options), [locale, options]);
}
...
function $bb77f239b46e8c72$export$3274cf84b703fff(options) {
    let collator = $325a3faab7a68acd$export$a16aca283550c30d(Object.assign({
        usage: 'search'
    }, options));
...
function useMessageFormatter(strings) {
    ...
    let formatter = useMemo(() => new $972eb555d604f491$export$526ebc05ff964723(locale, dictionary), [locale, dictionary]);
    return useCallback((key, variables) => formatter.format(key, variables), [formatter]);
}
export {
    $18f2051aff69b9bf$export$a54013f0d02a8f82 as I18nProvider, $325a3faab7a68acd$export$a16aca283550c30d as useCollator, $896ba0a80a8f4d36$export$85fd5fdf27bacc79 as useDateFormatter, $bb77f239b46e8c72$export$3274cf84b703fff as useFilter, $33bf17300c498528$export$a2f47a3d2973640 as useListFormatter, $18f2051aff69b9bf$export$43bb16f9c6d9e3f7 as useLocale, $fca6afa0e843324b$export$f12b703ca79dfbb1 as useLocalizedStringFormatter, useMessageFormatter, $a916eb452884faea$export$b7a616150fdb9f44 as useNumberFormatter
};