...
function $49c51c25361d4cd2$export$ee0f7cc6afcd1c18(options = {}) {
    ...
    useLayoutEffect(() => {
        ...
        if (isIOS()) return $49c51c25361d4cd2$var$preventScrollMobileSafari();
...
function $49c51c25361d4cd2$var$preventScrollMobileSafari() {
    ...
    let restoreStyles = chain($49c51c25361d4cd2$var$setStyle(document.documentElement, 'paddingRight', `${window.innerWidth - document.documentElement.clientWidth}px`), $49c51c25361d4cd2$var$setStyle(document.documentElement, 'overflow', 'hidden'), $49c51c25361d4cd2$var$setStyle(document.body, 'marginTop', `-${scrollY}px`));
