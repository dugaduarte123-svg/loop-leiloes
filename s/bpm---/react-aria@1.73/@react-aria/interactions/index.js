...
function $f6c31cce2adf654f$var$usePressResponderContext(props) {
    ...
    if (context) {
        ...
        contextProps = _objectWithoutPropertiesLoose(context, _excluded);
