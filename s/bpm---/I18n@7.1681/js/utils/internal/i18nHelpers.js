...
export const interpolate = function interpolate(message, options) {
    options = prepareOptions(options);
    const matches = message.match(DEFAULT_OPTIONS.placeholder);
...
export const pluralize = function pluralize(count, scope, options) {
    options = prepareOptions(options);
...
export const translate = function translate(scope, options) {
    options = prepareOptions(options);
    let translation = lookup(scope, options);
    ...
    if (typeof translation === 'string') {
        ...
        // END HACK
        translation = pluralize(options.count, translation, options);
