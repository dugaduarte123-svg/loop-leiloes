...
export const onINP = (onReport, opts = {}) => {
    ...
    whenActivated(() => {
        ...
        const po = observe(types, handleEntries, Object.assign({}, opts, {
            durationThreshold: (_opts$durationThresho = opts.durationThreshold) !== null && _opts$durationThresho !== void 0 ? _opts$durationThresho : DEFAULT_DURATION_THRESHOLD
        }));
        report = bindReporter(onReport, metric, INPThresholds, opts.reportAllChanges);
        if (po) {
