...
export const onLCP = (onReport, opts = {}) => {
    ...
    whenActivated(() => {
        ...
        const handleSoftNavEntry = entry => {
            ...
            const largestInteractionContentfulPaint = (_entry$getLargestInte = entry.getLargestInteractionContentfulPaint) === null || _entry$getLargestInte === void 0 ? void 0 : _entry$getLargestInte.call(entry);
        ...
        const handleEntries = entries => {
            ...
            for (const entry of entries) {
                ...
                if (entry.entryType === 'largest-contentful-paint') {
                    ...
                    renderTime = ((_ICPEntry$largestCont = ICPEntry.largestContentfulPaint) === null || _ICPEntry$largestCont === void 0 ? void 0 : _ICPEntry$largestCont.renderTime) || 0;
                        ...
                        if (!isFinalized) {
                            if (!softNavsEnabled) {
                                ...
                                for (const type of finalizeEventTypes) {
                                    removeEventListener(type, finalizeLCP, {
                                        capture: true
                                    });
                                }
                            }
