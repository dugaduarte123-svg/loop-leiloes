...
import {
    FCPEntryManager
} from '../lib/FCPEntryManager.js';
import {
    checkSoftNavsEnabled
} from '../lib/softNavs.js';
import {
    onFCP as unattributedOnFCP
} from '../onFCP.js';
export const onFCP = (onReport, opts = {}) => {
    ...
    const attributeFCP = metric => {
        ...
        if (metric.navigationType !== 'soft-navigation') {
            ...
            const navigationEntry = (_fcpEntryManager$_sof = fcpEntryManager._softNavigationEntryMap) === null || _fcpEntryManager$_sof === void 0 ? void 0 : _fcpEntryManager$_sof.get(metric.navigationId);
            if (navigationEntry) {
                attribution = {
                    timeToFirstByte: 0,
                    firstByteToFCP: metric.value,
        ...
        const metricWithAttribution = Object.assign(metric, {
            attribution
        });
