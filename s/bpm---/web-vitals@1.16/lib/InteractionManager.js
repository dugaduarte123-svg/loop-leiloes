...
import {
    getInteractionCount
} from './polyfills/interactionCountPolyfill.js';
...
export class InteractionManager {
    constructor() {
        ...
        this._onAfterProcessingINPCandidate = void 0;
    }
    /**
    ...
    _processEntry(entry) {
        ...
        if (interaction || this._longestInteractionList.length < MAX_INTERACTIONS_TO_CONSIDER ||
            ...
            (_this$_onAfterProcess = this._onAfterProcessingINPCandidate) === null || _this$_onAfterProcess === void 0 || _this$_onAfterProcess.call(this, interaction);
        }
    }
}