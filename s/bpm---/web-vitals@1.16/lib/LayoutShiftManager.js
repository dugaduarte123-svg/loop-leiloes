...
export class LayoutShiftManager {
    constructor() {
        this._onAfterProcessingUnexpectedShift = void 0;
    ...
    _processEntry(entry) {
        ...
        (_this$_onAfterProcess = this._onAfterProcessingUnexpectedShift) === null || _this$_onAfterProcess === void 0 || _this$_onAfterProcess.call(this, entry);
    }
}