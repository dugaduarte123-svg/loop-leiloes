...
export const getVisibilityWatcher = (reset = false) => {
    ...
    if (firstHiddenTime < 0) {
        ...
        const firstVisibilityStateHiddenTime = !document.prerendering ? (_globalThis$performan = globalThis.performance.getEntriesByType('visibility-state').find(e => e.name === 'hidden' && e.startTime >= activationStart)) === null || _globalThis$performan === void 0 ? void 0 : _globalThis$performan.startTime : undefined;
