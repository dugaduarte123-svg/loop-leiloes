...
export const checkSoftNavsEnabled = opts => {
    var _globalThis$Performan, _globalThis$Performan2;
    return (
        // Firefox has a preference to disable this, which some people use so add a guard
        ((_globalThis$Performan = globalThis.PerformanceObserver) === null || _globalThis$Performan === void 0 ? void 0 : _globalThis$Performan.supportedEntryTypes.includes('soft-navigation')) &&
        ...
        // to stable unflagged.
        typeof((_globalThis$Performan2 = globalThis.PerformanceSoftNavigation) === null || _globalThis$Performan2 === void 0 || (_globalThis$Performan2 = _globalThis$Performan2.prototype) === null || _globalThis$Performan2 === void 0 ? void 0 : _globalThis$Performan2.getLargestInteractionContentfulPaint) === 'function' && opts && opts.reportSoftNavs
    );
};
