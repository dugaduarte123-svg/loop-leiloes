...
export const initMetric = (name, value = -1, navigationType, navigationId = 0, navigationInteractionId, navigationURL, navigationStartTime) => {
    ...
    const hardNavId = (hardNavEntry === null || hardNavEntry === void 0 ? void 0 : hardNavEntry.navigationId) || 0;
    ...
    return {
        ...
        navigationURL: navigationURL || (hardNavEntry === null || hardNavEntry === void 0 ? void 0 : hardNavEntry.name),
