...
} from "apollo-stack-hubspot/@apollo/client/react/hooks/useSyncExternalStore";
import {
    equal
...
import {
    NetworkStatus
} from "apollo-stack-hubspot/@apollo/client/core/index";
import {
    DocumentType,
    verifyDocumentType
} from "apollo-stack-hubspot/@apollo/client/react/parser/index";
import {
    useApolloClient
} from "apollo-stack-hubspot/@apollo/client/react/hooks/useApolloClient";
import {
    compact,
    isNonEmptyArray,
    maybeDeepFreeze
...
import {
    wrapHook
} from "apollo-stack-hubspot/@apollo/client/react/hooks/internal/index";
...
function handleErrorOrCompleted(result, previousNetworkStatus, callbacks) {
    if (!result.loading) {
        ...
        Promise.resolve().then(function() {
            ...
            process.env.NODE_ENV !== "production" && invariant.warn(error);
        });
    }
}
