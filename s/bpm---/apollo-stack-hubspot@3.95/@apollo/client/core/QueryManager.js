...
import {
    canonicalStringify
} from "apollo-stack-hubspot/@apollo/client/cache/index";
import {
    getDefaultValues,
...
} from "apollo-stack-hubspot/@apollo/client/core/ObservableQuery";
import {
    NetworkStatus,
...
import {
    QueryInfo,
    shouldWriteResult
} from "apollo-stack-hubspot/@apollo/client/core/QueryInfo";
import {
...
var QueryManager = /** @class */ function() {
    ...
    QueryManager.prototype.getObservableQueries = function(include) {
        ...
        if (process.env.NODE_ENV !== "production" && queryNamesAndDocs.size) {
            queryNamesAndDocs.forEach(function(included, nameOrDoc) {
                if (!included) {
                    process.env.NODE_ENV !== "production" && invariant.warn(typeof nameOrDoc === "string" ? 34 : 35, nameOrDoc);
                }
            });
        }
        return queries;
    ...
    QueryManager.prototype.fetchQueryByPolicy = function(queryInfo, _a,
        ...
        var resultsFromCache = function resultsFromCache(diff, networkStatus) {
            ...
            if (process.env.NODE_ENV !== "production" && !returnPartialData && !equal(data, {})) {
