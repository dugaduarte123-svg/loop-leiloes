...
import {
    version
} from "apollo-stack-hubspot/@apollo/client/version";
import {
    HttpLink
} from "apollo-stack-hubspot/@apollo/client/link/http/index";
import {
    QueryManager
} from "apollo-stack-hubspot/@apollo/client/core/QueryManager";
import {
    LocalState
} from "apollo-stack-hubspot/@apollo/client/core/LocalState";
...
var ApolloClient = /** @class */ function() {
            ...
            if (window.document && window.top === window.self && /^(https?|file):$/.test(window.location.protocol)) {
                setTimeout(function() {
                    if (!window.__APOLLO_DEVTOOLS_GLOBAL_HOOK__) {
                        ...
                        if (url) {
                            process.env.NODE_ENV !== "production" && invariant.log("Download the Apollo DevTools for a better development " + "experience: %s", url);
                        }
                    }
                }, 10000);
            }
    ...
    ApolloClient.prototype.refetchQueries = function(options) {
        ...
        result.catch(function(error) {
            process.env.NODE_ENV !== "production" && invariant.debug(17, error);
        });
        return result;
    };
    /**
