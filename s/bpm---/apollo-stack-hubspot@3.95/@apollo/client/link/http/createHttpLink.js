...
} from "apollo-stack-hubspot/@apollo/client/link/http/serializeFetchParameter";
import {
    selectURI
} from "apollo-stack-hubspot/@apollo/client/link/http/selectURI";
import {
    handleError,
    readMultipartBody,
    parseAndCheckHttpResponse
} from "apollo-stack-hubspot/@apollo/client/link/http/parseAndCheckHttpResponse";
import {
    checkFetcher
} from "apollo-stack-hubspot/@apollo/client/link/http/checkFetcher";
import {
    selectHttpOptionsAndBodyInternal,
    defaultPrinter,
    fallbackHttpConfig
} from "apollo-stack-hubspot/@apollo/client/link/http/selectHttpOptionsAndBody";
import {
    rewriteURIForGET
} from "apollo-stack-hubspot/@apollo/client/link/http/rewriteURIForGET";
import {
    fromError,
    filterOperationVariables
} from "apollo-stack-hubspot/@apollo/client/link/utils/index";
import {
    maybe,
    getMainDefinition,
    ...
    return new ApolloLink(function(operation) {
        ...
        if (hasDefer || isSubscription) {
            ...
            if (isSubscription && hasDefer) {
                process.env.NODE_ENV !== "production" && invariant.warn(39);
            }
            if (isSubscription) {
