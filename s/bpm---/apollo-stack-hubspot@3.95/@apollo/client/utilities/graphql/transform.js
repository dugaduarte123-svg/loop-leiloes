...
import {
    ...
    getMainDefinition
} from "apollo-stack-hubspot/@apollo/client/utilities/graphql/getFromAST";
import {
    isField
} from "apollo-stack-hubspot/@apollo/client/utilities/graphql/storeUtils";
import {
    createFragmentMap
} from "apollo-stack-hubspot/@apollo/client/utilities/graphql/fragments";
import {
    isArray,
    isNonEmptyArray
...
export function removeDirectivesFromDocument(directives, doc) {
    ...
    var getInUse = function getInUse(ancestors) {
        ...
        process.env.NODE_ENV !== "production" && invariant.error(86);
        return null;
    };
    ...
    test: function(directive) {
        ...
        if (willRemove) {
            if (!directive.arguments || !directive.arguments.some(function(arg) {
                ...
                process.env.NODE_ENV !== "production" && invariant.warn(87);
            }
        }
        return willRemove;
    }
